 ...
 <section>
   ...
   <aside class="main-sidebar sidebar-dark-primary elevation-4">
     ...
     <a href="http://localhost/Nodin/public/home" class="brand-link">
       <img src="http://localhost/Nodin/public/template/dist/img/jkt-raya.png" alt="AdminLTE Logo"
     ...
     <aside class="main-sidebar sidebar-dark-primary elevation-4">
       ...
       <div class="sidebar">
         ...
         <div class="sidebar">
           ...
           <div class="user-panel mt-3 pb-3 mb-3 d-flex">
             <div class="image">
               <img src="http://localhost/Nodin/public/template/dist/img/user2-160x160.jpg"
                 class="img-circle elevation-2" alt="User Image">
             </div>
             <div class="info">
               <a href="http://localhost/Nodin/public/home/profile" class="d-block"><?= $nama ?></a>
             </div>
           </div>
